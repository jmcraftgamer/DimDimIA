...
function BanknoteLoadingIcon() {
  return (
    <div className="relative w-8 h-8" style={{ transform: 'rotate(-8deg)' }}>
      ...
      <div className="absolute -top-0.5 -right-0.5 w-3 h-3 bg-green-500 rounded-full border border-white shadow" />
    </div>
  )
}
